...
export default function MarketStats() {
  return (
    <section className="relative py-24 md:py-32 px-4" style={{ background: 'linear-gradient(180deg, transparent, rgba(0,212,255,0.03), transparent)' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[#00d4ff] text-xs font-bold tracking-[0.3em] uppercase mb-3 block">
        ...
        <div className="glass-glow rounded-2xl p-8 md:p-12 text-center mb-12 relative overflow-hidden">
          <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at center, #00d4ff, transparent 70%)' }} />
          <p className="relative text-[#94a3b8] text-xs tracking-[0.3em] uppercase mb-4">Pre-Seed Raise</p>
          <p className="relative font-mono text-5xl md:text-7xl text-white mb-2" style={{ textShadow: '0 0 40px rgba(0,212,255,0.4)' }}>
            {config.fundingAsk}
          </p>
          ...
          <div className="relative flex flex-wrap justify-center gap-4 text-xs">
            ...
            <span className="px-3 py-1 rounded-full bg-[#00d4ff]/10 border border-[#00d4ff]/30 text-[#00d4ff]">Equity: {config.equityOffered}</span>
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {config.projectedRevenue.map((rev) => (
              <div key={rev.year} className="rounded-xl p-5 border border-[#00d4ff]/20 bg-[#00d4ff]/5">
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { label: 'Strong', val: '$10M', return: '$2.0M', multiple: '8x', color: '#00d4ff' },
        ...
        <div className="text-center">
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #00d4ff, #00f0ff)', boxShadow: '0 0 30px rgba(0,212,255,0.3)' }}
          >
