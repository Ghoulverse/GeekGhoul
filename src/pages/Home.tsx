...
const PRODUCT_ICONS = [Keyboard, Monitor, Cable, ControllerIcon, Cpu];
const TABS = [
...
export default function Home() {
  ...
  return (
    <div className="relative font-inter min-h-screen overflow-x-hidden" style={{ background: '#0a0a0f' }}>
      ...
      <section ref={heroRef} className="relative min-h-[100dvh] flex flex-col items-center justify-center px-4 text-center overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[600px] h-[600px] rounded-full opacity-10 blur-[100px]"
            style={{ background: 'conic-gradient(from 0deg, #00d4ff, #00ff41, #f59e0b, #00d4ff)' }} />
        </div>
        ...
        <div className="relative z-10 pt-20">
          ...
          <div className="hero-sub mb-6">
            <span className="inline-flex items-center gap-2 px-4 py-2 text-[10px] font-bold tracking-[0.4em] uppercase border-2 border-[#00d4ff]/40 text-[#00d4ff]"
              ...
              The Digital Sanitizer
            </span>
          </div>

          <h1 className="hero-title font-mono leading-[0.85] mb-8" style={{ perspective: '1000px' }}>
            <span className="block text-[12vw] md:text-[10rem] lg:text-[14rem] text-[#00d4ff]"
              style={{ textShadow: '0 0 30px rgba(0,212,255,0.5), 0 0 80px rgba(0,212,255,0.3)' }}>
              <GlitchText text="GEEK" />
            </span>
            <span className="block text-[12vw] md:text-[10rem] lg:text-[14rem] text-[#00ff41] -mt-4 md:-mt-8"
              style={{ textShadow: '0 0 30px rgba(0,255,65,0.5), 0 0 80px rgba(0,255,65,0.3)' }}>
              <GlitchText text="GHOUL" />
            </span>
          </h1>

          <p className="hero-sub text-[#94a3b8] text-lg md:text-xl max-w-lg mx-auto mb-10 leading-relaxed">
            When the code compiles but the desk does not, <span className="text-[#00d4ff] font-bold">the real work begins.</span>
          </p>
          ...
          <div className="hero-sub flex items-center justify-center gap-4">
            <a href="#products" className="group inline-flex items-center gap-3 px-8 py-4 font-mono text-sm tracking-wider uppercase text-[#0a0a1a] transition-all hover:scale-105"
              style={{ background: 'linear-gradient(135deg, #00d4ff, #00ff41)', boxShadow: '0 0 30px rgba(0,212,255,0.4)' }}>
              INITIALIZE CLEANUP
        ...
        <div className="absolute bottom-0 left-0 right-0 h-px"
          style={{ background: 'linear-gradient(90deg, transparent, #00d4ff, #00ff41, transparent)' }} />
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-0">
            {[
              ...
              >
                <div className="font-mono text-5xl md:text-7xl mb-2 transition-all group-hover:scale-110"
      ...
      <section ref={scienceRef} className="relative py-24 md:py-40 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="reveal mb-16 text-center">
            <span className="inline-block text-[10px] font-bold tracking-[0.4em] uppercase text-[#00d4ff] mb-4 px-3 py-1 border border-[#00d4ff]/30">
              Proprietary Tech
            </span>
            <h2 className="font-mono text-4xl md:text-6xl text-white mb-4"
              style={{ textShadow: '0 0 20px rgba(255,255,255,0.1)' }}>
              THE SCIENCE
            </h2>
            <p className="text-[#00d4ff] text-xl md:text-2xl font-mono">
              {config.science.subtitle}
            </p>
          </div>

          <div className="reveal grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="p-8 border-2 border-[#00d4ff]/20" style={{ background: 'rgba(5,5,16,0.8)' }}>
              <p className="text-[#94a3b8] leading-relaxed">
                {config.science.description}
              </p>
            </div>
            <div className="p-8 border-2 border-[#00ff41]/20" style={{ background: 'rgba(5,5,16,0.8)' }}>
          ...
          <div className="reveal grid grid-cols-2 md:grid-cols-4 gap-3">
            {config.science.stats.map((stat, i) => (
              <div key={i} className="p-6 text-center border-2 group transition-all hover:border-[#00d4ff]"
                style={{ borderColor: '#00d4ff20', background: 'rgba(5,5,16,0.8)' }}>
                <div className="font-mono text-2xl md:text-3xl text-[#00d4ff] mb-1"
      ...
      <section ref={productRef} id="products" className="relative py-24 md:py-40 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="reveal mb-12 text-center">
            <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-[#00d4ff] mb-4 block">
            ...
            <p className="text-[#94a3b8] max-w-md mx-auto">
              Five lines. Nine formulations. Total system sanitization.
            </p>
          </div>
              ...
              return (
                <button key={tab.key} onClick={() => setActiveTab(tab.key)}
                  ...
                  style={{
                    ...
                    border: isActive ? '2px solid #00d4ff' : '2px solid #00d4ff30',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {filtered.map((product, i) => {
              ...
              const colors = ['#00d4ff', '#00ff41', '#f59e0b', '#00d4ff', '#00ff88'];
                ...
                >
                  ...
                  <div className="absolute -left-1.5 top-4 bottom-4 w-3 flex flex-col justify-between">
                    {Array.from({ length: 8 }).map((_, j) => (
                      <div key={j} className="w-3 h-2 rounded-full" style={{ background: '#0a0a0f' }} />
                    ))}
                  </div>
                  ...
                  <h3 className="font-mono text-base text-white mb-1 tracking-wide break-words">
                    {product.name.toUpperCase()}
                  </h3>
                  <p className="text-[#00d4ff] text-xs font-bold mb-3">{product.tagline}</p>
      ...
      <section ref={lineupRef} className="relative py-24 md:py-40 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="reveal text-center mb-16">
            <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-[#00ff41] mb-4 block">
              Festival Lineup
            </span>
            <h2 className="font-mono text-4xl md:text-6xl text-white mb-4"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-12">
            {OTHER_GHOULS.map((g) => (
              ...
              >
                ...
                <h3 className="font-mono text-xs text-white tracking-wider">{g.name}</h3>
          ...
          <div className="reveal text-center">
            <a href={GHOULVERSE_LINK?.domain || '#'} target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 font-mono text-sm tracking-wider uppercase text-[#0a0a1a] transition-all hover:scale-105"
              style={{ background: 'linear-gradient(135deg, #00d4ff, #00ff41)', boxShadow: '0 0 30px rgba(0,212,255,0.3)' }}>
      ...
      <section ref={gameRef} className="relative py-24 md:py-40 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="reveal relative p-10 md:p-16 text-center overflow-hidden"
            style={{ border: '2px solid #00d4ff40', background: 'linear-gradient(135deg, rgba(0,212,255,0.08), rgba(0,255,65,0.08))' }}>
            <div className="absolute top-0 left-0 w-10 h-10 border-t-2 border-l-2 border-[#00d4ff]" />
            <div className="absolute top-0 right-0 w-10 h-10 border-t-2 border-r-2 border-[#00ff41]" />
            <div className="absolute bottom-0 left-0 w-10 h-10 border-b-2 border-l-2 border-[#00ff41]" />
            <div className="absolute bottom-0 right-0 w-10 h-10 border-b-2 border-r-2 border-[#00d4ff]" />
      ...
      {/* ===== PORTFOLIO ===== */}
      <section ref={portfolioRef} className="relative py-16 px-4 border-t" style={{ borderColor: 'rgba(0,212,255,0.1)' }}>
        <div className="max-w-6xl mx-auto">
          <div className="reveal text-center mb-8">
            <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#94a3b8]/40 mb-2 block">The House of GHOUL</span>
            <h3 className="font-mono text-2xl text-white">THE PORTFOLIO</h3>
          </div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="reveal flex flex-col sm:flex-row gap-3 mb-16">
            <input type="email" placeholder={config.cta.placeholderText}
              className="flex-1 px-5 py-4 text-sm text-white placeholder:text-[#94a3b8]/40 outline-none bg-transparent border-2 transition-all focus:border-[#00d4ff]"
              style={{ borderColor: 'rgba(0,212,255,0.3)' }} />
            <button className="px-8 py-4 font-mono text-sm tracking-wider uppercase text-[#0a0a1a] transition-all hover:scale-105"
              style={{ background: 'linear-gradient(135deg, #00d4ff, #00ff41)', boxShadow: '0 0 20px rgba(0,212,255,0.3)' }}>
          ...
          <div className="reveal mb-8 flex items-center justify-center gap-4 text-xs">
            <a href={GHOULVERSE_LINK?.domain || '#'} target="_blank" rel="noopener noreferrer"
              className="text-[#94a3b8] hover:text-[#00d4ff] transition-colors flex items-center gap-1 tracking-wider py-2 px-3 min-h-11">
          ...
          <div className="reveal mb-4 flex items-center justify-center gap-3 text-[10px] tracking-wider uppercase text-[#78716c]/30">
            <a href="/privacy.html" className="hover:text-[#00d4ff] transition-colors">Privacy Policy</a>
            <span>|</span>
            <a href="/terms.html" className="hover:text-[#00d4ff] transition-colors">Terms of Service</a>
            <span>|</span>
            <a href="/cookies.html" className="hover:text-[#00d4ff] transition-colors">Cookie Policy</a>
          </div>

          <p className="reveal text-[#94a3b8]/20 text-xs tracking-wider">
            &copy; 2025 <span className="font-mono text-[#00d4ff]/40">{config.name}</span> — Part of the{' '}
            <a href={GHOULVERSE_LINK?.domain || '#'} target="_blank" rel="noopener noreferrer" className="hover:text-[#00d4ff] transition-colors">GHOULVERSE</a>
          </p>
        </div>
      </section>
    </div>
